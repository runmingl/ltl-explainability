...
\begin{figure}[h]
  \centering
  \begin{tikzpicture}
        \node[fill=white!50!gray, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (p1) {\!\!\!$p$\!\!\!};
        \node (p0) [left= 0.5cm of p1] {};
        \node (p2) [right= 0.5cm of p1] {};
        \draw[-latex, thick] (p0) edge (p1) (p1) edge (p2);
          
%        \draw[thick, black, -latex] (0,0) [partial ellipse=180:90:0.75cm and 0.5cm];
%        \draw[thick, black, -] (0,0) [partial ellipse=90:0:0.75cm and 0.5cm];
%
%        \draw[thick, black, -latex] (0,0) [partial ellipse=360:270:0.75cm and 0.5cm];
%        \draw[thick, black, -] (0,0) [partial ellipse=270:180:0.75cm and 0.5cm];
...
%        \draw[thick, black, -] (0,0) [partial ellipse=90:0:0.75cm and 0.5cm];
        ...
        \draw[thick, black, -latex] (-0.15,0) [partial ellipse=360:270:1cm and 0.7cm];
        \draw[thick, black, -] (-0.15,0) [partial ellipse=270:180:1cm and 0.7cm];
  ...
  \begin{tikzpicture}
        ...
        \draw[thick, black, -latex] (-0.05cm,0) [partial ellipse=180:90:1cm and 0.7cm];
        \draw[thick, black, -] (-0.05cm,0) [partial ellipse=90:0:1cm and 0.7cm];
...
\begin{example}
    ...
    \begin{figure}[!h]
        ...
        \node[draw, thick, fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (a1) [right= 0.75cm of s] {\!\!\!$\lnot a$\!\!\!};
        \node[draw, thick, fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (a2) [right= 0.75cm of a1] {\!\!\!$\dots$\!\!\!};
        \node[draw, thick, fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (a3) [right= 0.75cm of a2] {\!\!\!$\lnot a$\!\!\!};
        \node[draw, thick, fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (a4) [right= 0.75cm of a3] {\!\!\!$a$\!\!\!};
        \node[shape=rectangle, fill=gray!30!white, style={minimum width=1.8cm, minimum height=1.25cm}] (g) [right= 0.6cm of a4] {};
        \node[fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (a5) [right= 0.75cm of a4] {\!\!\!$1$\!\!\!};
        \draw[thick, line width=1.25] (s) edge[-latex] (a1) (a1) edge[-latex] (a2) (a2) edge[-latex] (a3) (a3) edge[-latex] (a4) (a4) edge[-latex] (a5);
...
\begin{example}
    ...
    \begin{figure}[h!]
        ...
        \begin{tikzpicture}
           \node[draw, thick, fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (s) {\!\!\!\!start\!\!\!\!};
           \node[draw, thick, fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (p1) [right= .75cm of s]{\!\!\!\!\!\!\!\!$p_2$\!\!\!\!\!\!\!\!};
           \node[draw, thick, fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (p2) [right= .75cm of p1]{\!\!\!\!\!\!\!\!$\tnot p_0 \! \tand \!  p_1$\!\!\!\!\!\!\!\!};
           \node[draw, thick, fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (p3) [right= .75cm of p2]{\!\!\!\!\!\!\!\!$\tnot p_0 \! \tand \!  p_1$\!\!\!\!\!\!\!\!};
           \node[draw, thick, fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (p4) [right= .75cm of p3]{\!\!\!\!\!\!\!\!$\dots$\!\!\!\!\!\!\!\!};
           \node[draw, thick, fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (p5) [right= .75cm of p4]{\!\!\!\!\!\!\!\!$\tnot p_0 \! \tand \!  p_1$\!\!\!\!\!\!\!\!};
           \node[draw, thick, fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (p6) [right= .75cm of p5]{\!\!\!\!\!\!\!\!$p_0 \! \tand \! p_1$\!\!\!\!\!\!\!\!};

           \node[draw, thick, fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (p7) [above= .6cm of p1]{\!\!\!\!\!\!\!\!$p_2$\!\!\!\!\!\!\!\!};
           \node[draw, thick, fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (p8) [above= .6cm of p6]{\!\!\!\!\!\!\!\!$p_0 \! \tand \! p_1$\!\!\!\!\!\!\!\!};
            \node (m) at ($(p6)!0.5!(p8)$) {};
            \node[shape=rectangle, fill=gray!30!white, style={minimum width=1.8cm, minimum height=1.25cm}] (g1) [right= 1cm of m] {};
           \node[fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (o1) [right= 1.15cm of m]{\!\!\!\!\!\!\!\!$p_1$\!\!\!\!\!\!\!\!};


           \node[draw, thick, fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (p9) [below= .6cm of p1]{\!\!\!\!\!\!\!\!$p_2$\!\!\!\!\!\!\!\!};
           \node[draw, thick, fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (p10) [below= .6cm of p2]{\!\!\!\!\!\!\!\!$1$\!\!\!\!\!\!\!\!};
	   \node[draw, thick, fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (p11) [below= .6cm of p3]{\!\!\!\!\!\!\!\!$1$\!\!\!\!\!\!\!\!};
           \node[draw, thick, fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (p12) [below= .6cm of p4]{\!\!\!\!\!\!\!\!$\dots$\!\!\!\!\!\!\!\!};
           \node[draw, thick, fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (p13) [below= .6cm of p5]{\!\!\!\!\!\!\!\!$1$\!\!\!\!\!\!\!\!};
           \node[shape=rectangle, fill=gray!30!white, style={minimum width=1.8cm, minimum height=1.25cm}] (g2) [right= 0.6cm of p13] {};

           \node[fill=white, shape=ellipse, style={minimum width=1.5cm, minimum height=1cm}] (p14) [below= .6cm of p6]{\!\!\!\!\!\!\!\!$p_0 \! \tand \! p_1$\!\!\!\!\!\!\!\!};

           \draw[thick, line width=1.25] (s) edge[-latex] (p1) (s) edge[-latex] (p7) (s) edge[-latex] (p9) (p1) edge[-latex] (p2) (p2) edge[-latex] (p3) (p3) edge[-latex] (p4) (p4) edge[-latex] (p5) (p5) edge[-latex] (p6) (p7) edge[-latex] (p8);
           \draw[thick, line width=1.25] (p8) edge[-latex] (o1) (p6) edge[-latex] (o1) (p9) edge[-latex] (p10) (p10) edge[-latex] (p11) (p11) edge[-latex] (p12) (p12) edge[-latex] (p13) (p13) edge[-latex] (p14);
...
\item {\bf Can there be back edges in a limited fashion (i.e., to simplify formulas) in timelines?} Most of our formulas have star-height of 1, so if we limit the back-edge representation to only surrounding a single node, that would simplify most formulas. We can then use the expanded notation for stared formulas larger than a single proposition, thus navigating a trade-off between small representation and limiting the visual complication. Do the back edges in a limited capacity cause confusion between timeline and automata representatins?

\item {\bf What are intuitive representations of star-formulas and do they change depending on the formula?} There are two ways to represent stars in regular expressions \cite{Runming where did you find these?}. We can represent a stared formula inside a box \cite{where?} or with a back edge \cite{where?}. Does using the box cause confusion with respect to the LTL $\Box$ operator? What is the most intuitive way to remind users of the corner case where the starred formula occurs zero times? 
...
\end{itemize}
KYR note: we should include a figure here with the different visual options we brainstormed and reference it in the bullets above.
