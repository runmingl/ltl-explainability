...
\usetikzlibrary{positioning,shapes,quotes}
...
\begin{proof}
    ...
    \begin{figure}[h!]
        \centering
        \begin{tikzpicture}
	\node[draw, thick, shape=ellipse, style={minimum width=1.5cm}] (u) {$u$};
	\node[draw, thick, shape=ellipse, style={minimum width=1.5cm}] (v) [right=of u] {$v$};
	\node[draw, thick, shape=ellipse, style={minimum width=1.5cm}] (w) [right=of v] {$w$};
