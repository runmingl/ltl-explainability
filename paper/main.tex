...
Define size, length, height, complexity, etc. here.

\subsection{Experimental Analysis} %We could come up with a less-generic name for this, which would be nicer...

Here we nicely summarize (with pictures as much as possible) all of the statistics and results we gathered.

<image>
caption: For all of the <large number> of real LTL formulas historically used to analyze real systems, \tool efficiently yields useable, readable timeine visualizations.
