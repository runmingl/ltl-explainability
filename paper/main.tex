...
\author{\IEEEauthorblockN{Runming Li\IEEEauthorrefmark{1}}
\IEEEauthorblockA{\textit{Carnegie Mellon University}\\
Pittsburgh, USA \\
runmingl@andrew.cmu.edu}
\and
\IEEEauthorblockN{Keerthana Gurushankar\IEEEauthorrefmark{1}}
\IEEEauthorblockA{\textit{Carnegie Mellon University}\\
Pittsburgh, USA \\
...
marijn@cmu.edu}
\and
\IEEEauthorblockN{Kristin~Y.~Rozier}
\IEEEauthorblockA{\textit{Iowa State University} \\
Ames, USA \\
ekyrozier@iastate.edu}
}
...
\begin{abstract}
  ...
  However, LTL formulas can be unintuitive and error-prone for human practitioners to specify and validate. Meanwhile, drawing timelines remains one of the most popular methods for specifying and validating requriements for industrial system designs, such as in aerospace operational concepts. 
...
\begin{remark}
  \Cref{def:regex,def:omega-regex} are the standard definitions of regular expressions and $\omega$-regular expressions, respectively. We include them here for completeness.
\end{remark}
...
\begin{itemize}
    ...
    \item The grey box means repeat infinitely. Once we reach the end of a timeline in the grey box, we must reenter the same grey box from any of its (left) starting point.
...
\begin{example}
    ...
    \begin{figure}[!h]
        ...
        \node (m) at ($(p1)!0.5!(p2)$) {};
        \node[shape=rectangle, fill=gray!30!white, style={minimum width=4.3cm, minimum height=1.25cm}] (g) [right= 1.35cm of m] {};
        ...
        \draw[thick, line width=1.25] (s) edge[-latex] (p1) (s) edge[-latex] (p3) (p3) edge[-latex] (p2) (p1) edge[-latex] (p4) (p2) edge[-latex] (p4) (p4) edge[-latex] (p5);
    ...
    \begin{figure}[!h]
        ...
        \begin{tikzpicture}[>=latex',line join=bevel, scale=0.7, transform shape]
          ...
          \begin{scope}
            ...
            \filldraw (287.84bp,8.0bp) -- (287.84bp,60.0bp) -- (357.84bp,60.0bp) -- (357.84bp,8.0bp) -- cycle;
          \end{scope}
            \pgfsetcolor{black}
            % Edge: start -> 0
            \draw [->] (54.252bp,34.0bp) .. controls (61.968bp,34.0bp) and (70.673bp,34.0bp)  .. (90.636bp,34.0bp);
            % Edge: 0 -> 1
            \draw [->] (169.36bp,34.0bp) .. controls (177.45bp,34.0bp) and (185.97bp,34.0bp)  .. (205.41bp,34.0bp);
            % Edge: 1 -> 2
            \draw [->] (260.25bp,34.0bp) .. controls (267.73bp,34.0bp) and (276.03bp,34.0bp)  .. (295.46bp,34.0bp);
            % Node: 2
          \begin{scope}
            ...
            \pgfsetfillcolor{fillcol}
            \filldraw [opacity=1] (322.84bp,34.0bp) ellipse (27.0bp and 18.0bp);
            \definecolor{strokecol}{rgb}{0.0,0.0,0.0};
            \pgfsetstrokecolor{strokecol}
            \draw (322.84bp,34.0bp) node {$\top$};
          \end{scope}
            % Node: start
          \begin{scope}
            \definecolor{strokecol}{rgb}{0.0,0.0,0.0};
          ...
          \begin{scope}
            \definecolor{strokecol}{rgb}{0.0,0.0,0.0};
            \pgfsetstrokecolor{strokecol}
            \draw (129.92bp,34.0bp) node [align=center] {$\neg \text{a}$ \\ {\tiny repeats $0$ - $\infty$}};
          \end{scope}
            % Node: 1
          \begin{scope}
            \definecolor{strokecol}{rgb}{0.0,0.0,0.0};
            \pgfsetstrokecolor{strokecol}
            \draw (232.84bp,34.0bp) ellipse (27.0bp and 18.0bp);
            \draw (232.84bp,34.0bp) node {$\text{a}$};
          \end{scope}
          %
          \end{tikzpicture}
...
\section{Algorithm}
On a high level, our algorithm of converting \ltl\ formulas into timeline visualizations works as follows:
\begin{enumerate}
...
Here we show a demonstrating subset of simplification rules we encoded. In theory one could add more rules to the tool, so long as they are sound; here we only choose to encode the rules that represent common patterns we have observed in the generated $\omega$-regular expression.
\begin{alignat*}{2}
                ...
                \resizebox{\textwidth}{!}{
                    \begin{tikzpicture}[>=latex',line join=bevel,]
                      ...
                      \begin{scope}
                        ...
                        \definecolor{strokecol}{rgb}{0.0,0.0,0.0};
                        \pgfsetstrokecolor{strokecol}
                        \draw (506.18bp,34.0bp) node [align=center] {$\text{a}$ \\ {\tiny repeats $0$ - $\infty$}};
                      \end{scope}
                        % Node: 7
                      \begin{scope}
                        \definecolor{strokecol}{rgb}{1.0,1.0,1.0};
                      ...
                      \begin{scope}
                        ...
                        \draw (216.73bp,38.0bp) node [align=center] {$\text{a}$ \\ {\tiny repeats $0$ - $\infty$}};
                      \end{scope}
                        % Node: 3
                      \begin{scope}
                        \definecolor{strokecol}{rgb}{0.0,0.0,0.0};
        ...
        \resizebox{.8\textwidth}{!}{
            \begin{tikzpicture}[>=latex',line join=bevel,]
              ...
              \begin{scope}
                ...
                \definecolor{strokecol}{rgb}{0.0,0.0,0.0};
                \pgfsetstrokecolor{strokecol}
                \draw (216.73bp,34.0bp) node [align=center] {$\text{a}$ \\ {\tiny repeats $0$ - $\infty$}};
              \end{scope}
                % Node: 3
              \begin{scope}
                \definecolor{strokecol}{rgb}{1.0,1.0,1.0};
...
\begin{enumerate}
  ...
  \item $B = AB$. Visualized as the timeline of $A$ followed by the timeline of $B$. A concatenation of a regular expression and an $\omega$-regular expression signifies that the first must be true before the second $\omega$-regular expression can be true in the time step.
        ...
        \resizebox{\textwidth}{!}{
            \begin{tikzpicture}[>=latex',line join=bevel,]
              ...
              \begin{scope}
                ...
                \draw (331.29bp,88.0bp) node [align=center] {$\neg \text{p0} \land \text{p1}$ \\ {\tiny repeats $0$ - $\infty$}};
              \end{scope}
                % Node: 5
              \begin{scope}
                \definecolor{strokecol}{rgb}{0.0,0.0,0.0};
              ...
              \begin{scope}
                ...
                \draw (331.29bp,34.0bp) node [align=center] {$\top$ \\ {\tiny repeats $0$ - $\infty$}};
              \end{scope}
              %
              \end{tikzpicture}}
...
\begin{figure}[h!]
    \centering
    \subfloat{{\includegraphics[width=6.5cm]{img/tllens-graph.png} }}%
    \quad % [\centering label 1]
    \subfloat{{\includegraphics[width=6.5cm]{img/star-height-graph.png}}}
