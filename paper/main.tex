...
Our tool, \tool, uses a remarkably simple algorithm: transforming an input \ltl\ formula through a sequence of automaton and regular expression-based intermediate representations, and is surprisingly effective at providing small representations for a range of \ltl formulas. It would visualize the above air traffic control requirement behavior with the following timeline:
\begin{figure}[!h]
    \centering
